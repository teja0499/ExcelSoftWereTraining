...
<html>
  ...
  <body>
    ...
    <div id="loading" class='container text-center'></div>
    ...
    <script>
      $(document).ready(function () {
		...
		//	let ab=Date.now().toLocaleDateTimeString();
			// console.log(new Date());
	  const fileName = Math.floor(1000000000 + Math.random() * 9000000000);
			
    $.ajax({
        url: "http://localhost:8080/Crud/getExcelFile",
        type: "GET",
		data: {fileName:fileName ,name: $("#inpsearch").val().trim()},
        beforeSend: function () {
            console.log("Sending excel request");
        },
        success: function (response) {
            console.log(response.excelLink);
            // Open the  Excel file in a new tab
            
            window.open("http://localhost:8080/Crud/ExcelFiles/"+fileName+".xls", "_blank");
        },
