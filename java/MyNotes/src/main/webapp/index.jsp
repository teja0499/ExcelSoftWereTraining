...
<form action="signUpForm" method="post" class="row g-3 needs-validation" >
        <div class="col-md-6">
...
<!--           <button class="btn btn-primary" id="submit" type="submit">
 ...
 -->            
  <input type="submit" value="submit"  class="btn btn-primary" id="submit" />
      ...
      <div class="text-center">
       <form action="loginForm" method="get" style="display: inline;">
 ...
 <script
   ...
   <script>
    ...
    //       console.log($("#password").val());
    //       console.log("ggggggggggggggg",selectedGender);
