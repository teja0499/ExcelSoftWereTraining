		...
		<form id="formId">
			<div id="form">
				...
				<div style="display: flex; justify-content: space-between">
				  ...
				  <div class="d-flex form-container">
        <label>To CN/DN number: </label>
        <select id="tocn" name="tocn">
            <option value="S">Select</option>
        </select>
    </div>
...
$(document).ready(function () {
    ...
    $("#tableData").on("change", "input[name='table']", function() {
        ...
        // Get the data-key of the selected radio button
        let index = $(this).data("key");
        
        
        $('#fromcn').prop('selectedIndex', index-1);
        // Log the values for debugging
       // console.log("Selected radio value:", selectedValue);
       // console.log("Selected key:", index);
        
        // Set the selectedValue in the #fromcn select element
        $('#fromcn').val(selectedValue);
    });
